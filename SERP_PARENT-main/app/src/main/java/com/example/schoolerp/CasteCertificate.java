 ...
 */
public class CasteCertificate extends Fragment {
     ...
     * @return A new instance of fragment CasteCertificate.
     */
    // TODO: Rename and change types and number of parameters
    public static CasteCertificate newInstance(String param1, String param2) {
        CasteCertificate fragment = new CasteCertificate();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_caste_certificate, container, false);
    }

    @Override
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        inflater.inflate(R.menu.castecertificate_menu, menu);
